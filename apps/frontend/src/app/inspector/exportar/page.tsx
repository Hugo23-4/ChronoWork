        ...
        <div className="animate-fade-up">
            ...
            <div className="md:hidden">
                ...
                <div className="bg-white rounded-2xl p-3.5 mb-4 shadow-sm border border-gray-100">
                    <div className="flex justify-between items-center py-3 border-b border-gray-100"><span className="font-bold text-navy text-sm">Periodo</span><span className="text-amber-500 font-bold text-sm">{new Date(periodo.inicio + 'T00:00:00').toLocaleDateString('es-ES', { month: 'long', year: 'numeric' })}</span></div>
